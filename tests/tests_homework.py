...
class TestRectangle(unittest.TestCase):
    ...
    def test_get_rectangle_perimeter(self):
        self.assertEqual(rectangle.get_rectangle_perimeter(), 6)

    def test_get_rectangle_square(self):
        self.assertEqual(rectangle.get_rectangle_square(), 2)
    ...
    def test_get_radius_of_circumscribed_circle(self):
        self.assertEqual(int(rectangle.get_radius_of_circumscribed_circle()), 1)
